...
func (TxPriority) Descriptor() protoreflect.EnumDescriptor {
	return file_celestia_core_v1_gas_estimation_gas_estimator_proto_enumTypes[0].Descriptor()
}

func (TxPriority) Type() protoreflect.EnumType {
	return &file_celestia_core_v1_gas_estimation_gas_estimator_proto_enumTypes[0]
}
...
func (TxPriority) EnumDescriptor() ([]byte, []int) {
	return file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescGZIP(), []int{0}
}
...
func (x *EstimateGasPriceRequest) Reset() {
	*x = EstimateGasPriceRequest{}
	mi := &file_celestia_core_v1_gas_estimation_gas_estimator_proto_msgTypes[0]
...
func (x *EstimateGasPriceResponse) Reset() {
	*x = EstimateGasPriceResponse{}
	mi := &file_celestia_core_v1_gas_estimation_gas_estimator_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EstimateGasPriceResponse) Descriptor() ([]byte, []int) {
	return file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescGZIP(), []int{1}
}
...
func (x *EstimateGasPriceAndUsageRequest) Reset() {
	*x = EstimateGasPriceAndUsageRequest{}
	mi := &file_celestia_core_v1_gas_estimation_gas_estimator_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EstimateGasPriceAndUsageRequest) Descriptor() ([]byte, []int) {
	return file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescGZIP(), []int{2}
}
...
func (x *EstimateGasPriceAndUsageResponse) Reset() {
	*x = EstimateGasPriceAndUsageResponse{}
	mi := &file_celestia_core_v1_gas_estimation_gas_estimator_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EstimateGasPriceAndUsageResponse) Descriptor() ([]byte, []int) {
	return file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescGZIP(), []int{3}
}
...
var File_celestia_core_v1_gas_estimation_gas_estimator_proto protoreflect.FileDescriptor

const file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDesc = "" +
	"\n" +
	"3celestia/core/v1/gas_estimation/gas_estimator.proto\x12\x1fcelestia.core.v1.gas_estimation\"g\n" +
	"\x17EstimateGasPriceRequest\x12L\n" +
	"\vtx_priority\x18\x01 \x01(\x0e2+.celestia.core.v1.gas_estimation.TxPriorityR\n" +
	"txPriority\"J\n" +
	"\x18EstimateGasPriceResponse\x12.\n" +
	"\x13estimated_gas_price\x18\x01 \x01(\x01R\x11estimatedGasPrice\"\x8a\x01\n" +
	"\x1fEstimateGasPriceAndUsageRequest\x12L\n" +
	"\vtx_priority\x18\x01 \x01(\x0e2+.celestia.core.v1.gas_estimation.TxPriorityR\n" +
	"txPriority\x12\x19\n" +
...
var (
	file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescOnce sync.Once
	file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescData []byte
)

func file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescGZIP() []byte {
	file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescOnce.Do(func() {
		file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDesc), len(file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDesc)))
	})
	return file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDescData
}

var file_celestia_core_v1_gas_estimation_gas_estimator_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_celestia_core_v1_gas_estimation_gas_estimator_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_celestia_core_v1_gas_estimation_gas_estimator_proto_goTypes = []any{
	(TxPriority)(0),                          // 0: celestia.core.v1.gas_estimation.TxPriority
	(*EstimateGasPriceRequest)(nil),          // 1: celestia.core.v1.gas_estimation.EstimateGasPriceRequest
	(*EstimateGasPriceResponse)(nil),         // 2: celestia.core.v1.gas_estimation.EstimateGasPriceResponse
	(*EstimateGasPriceAndUsageRequest)(nil),  // 3: celestia.core.v1.gas_estimation.EstimateGasPriceAndUsageRequest
	(*EstimateGasPriceAndUsageResponse)(nil), // 4: celestia.core.v1.gas_estimation.EstimateGasPriceAndUsageResponse
}
var file_celestia_core_v1_gas_estimation_gas_estimator_proto_depIdxs = []int32{
	0, // 0: celestia.core.v1.gas_estimation.EstimateGasPriceRequest.tx_priority:type_name -> celestia.core.v1.gas_estimation.TxPriority
	0, // 1: celestia.core.v1.gas_estimation.EstimateGasPriceAndUsageRequest.tx_priority:type_name -> celestia.core.v1.gas_estimation.TxPriority
	1, // 2: celestia.core.v1.gas_estimation.GasEstimator.EstimateGasPrice:input_type -> celestia.core.v1.gas_estimation.EstimateGasPriceRequest
	3, // 3: celestia.core.v1.gas_estimation.GasEstimator.EstimateGasPriceAndUsage:input_type -> celestia.core.v1.gas_estimation.EstimateGasPriceAndUsageRequest
	2, // 4: celestia.core.v1.gas_estimation.GasEstimator.EstimateGasPrice:output_type -> celestia.core.v1.gas_estimation.EstimateGasPriceResponse
	4, // 5: celestia.core.v1.gas_estimation.GasEstimator.EstimateGasPriceAndUsage:output_type -> celestia.core.v1.gas_estimation.EstimateGasPriceAndUsageResponse
...
func init() { file_celestia_core_v1_gas_estimation_gas_estimator_proto_init() }
func file_celestia_core_v1_gas_estimation_gas_estimator_proto_init() {
	if File_celestia_core_v1_gas_estimation_gas_estimator_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDesc), len(file_celestia_core_v1_gas_estimation_gas_estimator_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_celestia_core_v1_gas_estimation_gas_estimator_proto_goTypes,
		DependencyIndexes: file_celestia_core_v1_gas_estimation_gas_estimator_proto_depIdxs,
		EnumInfos:         file_celestia_core_v1_gas_estimation_gas_estimator_proto_enumTypes,
		MessageInfos:      file_celestia_core_v1_gas_estimation_gas_estimator_proto_msgTypes,
	}.Build()
	File_celestia_core_v1_gas_estimation_gas_estimator_proto = out.File
	file_celestia_core_v1_gas_estimation_gas_estimator_proto_goTypes = nil
	file_celestia_core_v1_gas_estimation_gas_estimator_proto_depIdxs = nil
}
