...
const (
	Msg_PayForBlobs_FullMethodName      = "/celestia.blob.v1.Msg/PayForBlobs"
	Msg_UpdateBlobParams_FullMethodName = "/celestia.blob.v1.Msg/UpdateBlobParams"
)
...
func (c *msgClient) PayForBlobs(ctx context.Context, in *MsgPayForBlobs, opts ...grpc.CallOption) (*MsgPayForBlobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_PayForBlobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateBlobParams(ctx context.Context, in *MsgUpdateBlobParams, opts ...grpc.CallOption) (*MsgUpdateBlobParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_UpdateBlobParams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) UpdateBlobParams(context.Context, *MsgUpdateBlobParams) (*MsgUpdateBlobParamsResponse, error) {
...
func _Msg_UpdateBlobParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_UpdateBlobParams_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
